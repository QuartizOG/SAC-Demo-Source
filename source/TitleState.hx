	...
	override function beatHit()
	{
		...
		if (!closedState)
		{
			...
			switch (sickBeats)
			{
				...
				case 6:
					deleteCoolText();
					createCoolText(['Shapes And Colors by'], 45);
					addMoreText('Dool',45);
					addMoreText('Xeno4K',45);
					addMoreText('KyberLatch',45);
					addMoreText('Quartiz',45);
					addMoreText('Lag',45);
					addMoreText('Fern',45);
					addMoreText('Neutron',45);
				case 8:
					deleteCoolText();
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Colors'); // credTextShit.text += '\nColors';
