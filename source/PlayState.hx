...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
	    ['Its not hard youre just bad', 0.1], //From 0% to 4%
		['You Suck!', 0.2], //From 5% to 19%
	...
	override public function create()
	{
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "You are not shaping or coloring", 32);
