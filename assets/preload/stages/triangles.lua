...
function onCreate()
	...
	makeLuaSprite('triangles', 'triangles', -650, -460);
	setScrollFactor('triangles', 0.9, 0.9);
	scaleObject('triangles', 1.1, 1.1);

	addGlitchEffect('triangles', 2.2);


	addLuaSprite('triangles', false);
